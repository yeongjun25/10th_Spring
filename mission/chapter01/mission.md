...
![1주차_제이의_유리_피어리뷰.jpg](./images/1주차_제이의_유리_피어리뷰.jpg)
    
### 제이 > 유리 피어리뷰

> 키워드 정리 스타일이 깔끔하고 눈에 잘 들어온다고 생각한다.
또한 트랜잭션의 특성 뿐만 아니라 핵심 용어 3가지 (Commit>, Rollback, Savepoint)에 대해서도 따로 정리를 해놓은 점이 좋아보였다.
